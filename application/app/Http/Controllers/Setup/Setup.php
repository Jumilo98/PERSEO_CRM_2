...
class Setup extends Controller
{
    ...
    public function updateDatabase(EnvRepository $envrepo)
    {
        ...
        //connect
        $connection = @mysqli_connect($dbhost, $dbuser, $dbpass, $dbname, $dbport) or abort(409, __('Error(1001): Unable to connect to your database. Check details and try again'));
    ...
    public function postActions()
    {
         ...
         * -------------------------------------------------------------------------*/
        DB::table('crm_plantillasdecontrato')->update([
            'contract_template_created' => now(),
        ]);

        DB::table('crm_plantillasdepropuesta')->update([
